	...
	public void processForecasting(final View view, final Model model) {		
		...
		loadForecastingButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				query = QueryFactory.createQuery(parentController.geoComboBoxSelection, parentController.args, 
				...
				if (parentController.geoComboBoxSelection.equals("3 Provinces") 
						|| parentController.geoComboBoxSelection.equals("3 Towns")) {
