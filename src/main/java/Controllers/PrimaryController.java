	...
	public PrimaryController(final View view, final Model model) {
		...
		geographicalParametersComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    view.getCardLayout1().show(view.getGeographicalParametersPTSubPanel(), 
			    		geographicalParametersPanelMap.get(geoComboBoxSelection).getPanelName());
			}
		});
		...
		timeGranularityComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    view.getCardLayout2().show(view.getTimeParametersBMYSubPanel(), 
			    		geographicalParametersPanelMap.get(timeComboBoxSelection).getPanelName());
			}
		});
		// Process raw data.
